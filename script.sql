...
insert into users (isAdmin, age, createdDate, name) values (1, 47, '2013-09-01', 'user_27');
insert into users (isAdmin, age, createdDate, name) values (0, 48, '2013-09-02', 'user_28');
insert into users (isAdmin, age, createdDate, name) values (1, 49, '2013-09-03', 'user_29');
insert into users (isAdmin, age, createdDate, name) values (0, 50, '2013-09-04', 'user_30');
